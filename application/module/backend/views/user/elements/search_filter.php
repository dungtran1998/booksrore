...
$showFilterStatus = HelperBackend::showFilterStatus($this->arrParams["module"], $this->arrParams["controller"], $this->itemStatusCount, $this->arrParams["status"] ?? "all", $this->arrParams["search"] ?? "", true);
...
$searchByArr = ["all" => "Search By All", "id" => "Search By ID", "username" => "Search By Name"];
